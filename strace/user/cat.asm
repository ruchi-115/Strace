...
void cat(int fd) {
  ...
  4b:	68 fd 08 00 00       	push   $0x8fd
  50:	6a 01                	push   $0x1
  52:	e8 df 04 00 00       	call   536 <printf>
...
int main(int argc, char *argv[]) {
  ...
  d6:	50                   	push   %eax
  d7:	68 0e 09 00 00       	push   $0x90e
  dc:	6a 01                	push   $0x1
  de:	e8 53 04 00 00       	call   536 <printf>
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 4d4:	0f b6 91 94 0b 00 00 	movzbl 0xb94(%ecx),%edx
...
void printf(int fd, char *fmt, ...) {
 ...
 612:	75 25                	jne    639 <printf+0x103>
          s = "(null)";
 614:	c7 45 f4 23 09 00 00 	movl   $0x923,-0xc(%ebp)
        while (*s != 0) {
